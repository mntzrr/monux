...
use hyprland::{hyprland_layout, run_cursor_poller, wait_for_hyprland};
...
pub(crate) mod tests {
    ...
    /// A plain output rect (no persistent identifiers), the common fixture
    /// for the geometry tests. Shared with the hyprland module's tests.
    pub(crate) fn rect(name: &str, x: i32, y: i32, width: i32, height: i32) -> OutputRect {
        OutputRect {
            name: name.to_string(),
            make: String::new(),
            model: String::new(),
