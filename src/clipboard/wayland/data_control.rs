//! Derived from data_control.rs here, with modifications:
//! https://github.com/YaLTeR/wl-clipboard-rs/blob/master/src/data_control.rs
        ...
        $(
            impl Dispatch<$iface, ()> for $handler {
                fn event(
                    ...
                    let source = $crate::clipboard::wayland::data_control::Source::from(proxy.clone());
        ...
        $(
            impl Dispatch<$iface, ()> for $handler {
                fn event(
                    ...
                    let offer = $crate::clipboard::wayland::data_control::Offer::from(proxy.clone());
